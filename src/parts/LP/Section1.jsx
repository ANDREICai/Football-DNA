...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden text-center px-4">
      {/* Video Background */}
      <video
        autoPlay
        loop
      ...
      <div className="relative z-20 max-w-3xl">
        ...
        <p className="mt-4 sm:mt-6 text-lg sm:text-2xl text-white/90">
         Welcome to Football DNA West Lothians best Football Coaching
        </p>
        <button
